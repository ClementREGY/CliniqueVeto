...
{
    public partial class FormRelance_VaccinCourrier : Form
    {
        #region Attributs et Propriétés

        private FormRelance_VaccinSelection frmRelance = null;

        #endregion

        public FormRelance_VaccinCourrier(FormRelance_VaccinSelection frm)
        {
            InitializeComponent();
            frmRelance = frm;
        }
        ...
        {
            MgtRelanceVaccins.SetRelanceEnvoye(frmRelance.RelanceCourante);
        }
